...
class AboutsControllerTest < ActionController::TestCase
  ...
  test "should create about" do
    assert_difference('About.count') do
      post :create, about: { avatar: @about.avatar, description: @about.description, function: @about.function, name: @about.name }
    end
  ...
  test "should update about" do
    patch :update, id: @about, about: { avatar: @about.avatar, description: @about.description, function: @about.function, name: @about.name }
    assert_redirected_to about_path(assigns(:about))
  end
